      ...
      <div className="row justify-content-center align-items-center">
        ...
        <div className="col-12 col-md-5 mb-4 d-flex justify-content-center">
          <img
            src={book.image}
            alt={book.name}
            className="img-fluid rounded shadow-lg vh-20 w-auto"
          />
        </div>
        ...
        <div className="col-12 col-md-6">
          ...
          <div className="d-grid d-md-block">
            <button className="btn btn-dark btn-lg px-5 me-md-3 mb-3">
              Buy Now
            </button>
            <Link
              to="/display"
              className="btn btn-outline-secondary btn-lg px-4 mb-3"
            >
              Back to Store
            </Link>
          </div>
